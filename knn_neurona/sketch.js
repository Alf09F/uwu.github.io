  ...
  if (Clasificando) {
    ...
    knn.classify(Imagen, function(error, result) {
      if (error) {
        ...
        if(Etiqueta=="PET" && Confianza==100)
        {
          window.open('https://planetedupet.mobirisesite.com/');
          
        }
        if(Etiqueta=="Lata" && Confianza==100)
        {
          window.open('https://www.cleanipedia.com/ar/sustentabilidad/como-se-recicla-el-aluminio.html');
          
        }
        if(Etiqueta=="Vidrio")
        {
          window.open('https://residuosexpo.com/2023/');
